...
apt-get update
apt-get install -y python-certbot-nginx
certbot certonly --force-interactive --webroot -w /var/www/test.adminforum.online -d wp.adminforum.online --email admin@wp.adminforum.online
